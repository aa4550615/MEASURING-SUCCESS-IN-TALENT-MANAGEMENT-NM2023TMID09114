...
Globalize.b796119710 = messageFormatterFn((function(  ) {
  return function(d) { return " " + d.count + "+"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b604284057 = messageFormatterFn((function(  ) {
  return function(d) { return "Disconnected Tables"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.b1768782751 = messageFormatterFn((function(  ) {
  return function(d) { return "This table has multiple problems."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1706851742 = messageFormatterFn((function(  ) {
  return function(d) { return "Show Islands"; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b689749607 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship is of an unsupported type."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1172902119 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has an invalid field."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b1127334394 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has a bad clause."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a136850830 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has an empty clause."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b486312564 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has a type mismatch."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a615593781 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has a non-spatial type."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b556084347 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has a bad input."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.b2074388106 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has an invalid calculation."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1437736004 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has a non-spatial comparison."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1995123964 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has an unsupported join."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a1206014778 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has repeated field references."; }
})(), Globalize("en").pluralGenerator({}));
Globalize.a858018035 = messageFormatterFn((function(  ) {
  return function(d) { return "This relationship has an issue."; }
})(), Globalize("en").pluralGenerator({}));
